...
fn hihat_engine_harmonics() {
    ...
    write_wav(
        "engines/hihat/hihat_harmonics.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/hihat/hihat_harmonics_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn hihat_engine_timbre() {
    ...
    write_wav(
        "engines/hihat/hihat_timbre.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/hihat/hihat_timbre_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn hihat_engine_morph() {
    ...
    write_wav(
        "engines/hihat/hihat_morph.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/hihat/hihat_morph_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
