...
#[test]
fn swarm_engine_harmonics() {
    let mut engine = swarm_engine::SwarmEngine::new();
    ...
    write_wav(
        "engines/swarm/swarm_harmonics.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/swarm/swarm_harmonics_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn swarm_engine_timbre() {
    ...
    write_wav(
        "engines/swarm/swarm_timbre.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/swarm/swarm_timbre_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn swarm_engine_morph() {
    ...
    write_wav(
        "engines/swarm/swarm_morph.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/swarm/swarm_morph_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
