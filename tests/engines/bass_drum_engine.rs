...
#[test]
fn bass_drum_engine_harmonics() {
    let mut engine = bass_drum_engine::BassDrumEngine::new();
    ...
    write_wav(
        "engines/bass_drum/bass_drum_harmonics.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/bass_drum/bass_drum_harmonics_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn bass_drum_engine_timbre() {
    ...
    write_wav(
        "engines/bass_drum/bass_drum_timbre.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/bass_drum/bass_drum_timbre_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn bass_drum_engine_morph() {
    ...
    write_wav(
        "engines/bass_drum/bass_drum_morph.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/bass_drum/bass_drum_morph_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
