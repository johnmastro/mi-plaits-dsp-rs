//! Tests for string machine engine
...
#[test]
fn string_machine_engine_harmonics() {
    let mut engine = string_machine_engine::StringMachineEngine::new();
...
#[test]
fn string_machine_engine_timbre() {
    let mut engine = string_machine_engine::StringMachineEngine::new();
    let mut out = [0.0; BLOCK_SIZE];
    let mut aux = [0.0; BLOCK_SIZE];
    let mut wav_data = Vec::new();
...
#[test]
fn string_machine_engine_morph() {
    let mut engine = string_machine_engine::StringMachineEngine::new();
    let mut out = [0.0; BLOCK_SIZE];
    let mut aux = [0.0; BLOCK_SIZE];
    let mut wav_data = Vec::new();
