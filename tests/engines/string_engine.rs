...
#[test]
fn string_engine_harmonics() {
    let mut engine = string_engine::StringEngine::new(BLOCK_SIZE);
    ...
    write_wav(
        "engines/string/string_harmonics.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/string/string_harmonics_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn string_engine_timbre() {
    ...
    write_wav(
        "engines/string/string_timbre.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/string/string_timbre_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
...
fn string_engine_morph() {
    ...
    write_wav(
        "engines/string/string_morph.wav",
        &wav_data,
        SAMPLE_RATE as u32,
    )
    .ok();
    write_wav(
        "engines/string/string_morph_aux.wav",
        &wav_data_aux,
        SAMPLE_RATE as u32,
    )
    .ok();
